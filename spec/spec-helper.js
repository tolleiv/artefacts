...
var server, app, started=false, port=3000;

exports.req = {
    get: function (path, callback) {
        return request("http://127.0.0.1:" + port + path, callback);
    },
    ...
    del: function(path, callback) {
        return request.del("http://127.0.0.1:" + port + path, callback);
    }
};
...
exports.start = function(persist, models, objects) {
    port = port + Math.round(Math.random()*50)
    return function() {
        persist.env = 'dev';
