    ...
    app.post("/pipeline", function (req, res) {
        ...
        helper.getModelObjects(app, data,
            function(models) {
                ...
                delete data.state_machine_id
                data.project = models.project;
                data.statemachine = models.statemachine
            ...
            function(errors) {
                if (errors['project']) helper.forwardOrFail.call(res, 404, { message: 'Project invalid', error: 20140602072100 })
                else helper.forwardOrFail.call(res, 404, { message: 'StateMachine invalid', error: 20140602072101 })
            }
        );
    });
