...
exports.resolveRelatedObjectsById = resolveRelatedObjectsById = function (app, data, callbackOk, callbackNok) {
    var list = {};
...
exports.resolveRelatedObjectsBySlug = resolveRelatedObjectsBySlug = function (app, data, callbackOk, callbackNok) {
    var list = {};
...
exports.resolveObjectsById = function (req, res, next) {
    resolveRelatedObjectsById(this, req.body,
        function (result) {
            req.model = result;
            next();
        },
